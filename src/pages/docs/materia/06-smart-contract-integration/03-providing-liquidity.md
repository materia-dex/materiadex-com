...
The easiest way to safely add liquidity to a pool is to use the <Link to='/docs/materia/smart-contracts/orchestrator'>orchestrator</Link>, which provides simple methods to safely add liquidity to a pool.
