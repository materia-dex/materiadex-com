...
To see an interactive sandbox of all entities see the [Graph Explorer](https://thegraph.com/explorer/subgraph/materia-dex/materia).
...
| pairCount         | Int        | amount of pairs created by the Materia factory                  |
...
| factory              | MateriaFactory      | reference to Materia factory entity                                                                                 |
...
A user entity is created for any address that provides liquidity to a pool on Materia. This entity
...
| gasUsed       | BigInt     | the value of gas used from the transaction     |
| gasPrice       | BigInt    | the value of the gas price used from the transaction     |
